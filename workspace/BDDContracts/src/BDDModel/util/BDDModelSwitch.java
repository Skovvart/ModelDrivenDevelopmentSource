 ...
 * @generated
 */
public class BDDModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BDDModelPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.SCENARIO: {
				Scenario scenario = (Scenario)theEObject;
				T result = caseScenario(scenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.SCENARIO_SPECIFIC: {
				ScenarioSpecific scenarioSpecific = (ScenarioSpecific)theEObject;
				T result = caseScenarioSpecific(scenarioSpecific);
				if (result == null) result = caseScenario(scenarioSpecific);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.SCENARIO_OUTLINE: {
				ScenarioOutline scenarioOutline = (ScenarioOutline)theEObject;
				T result = caseScenarioOutline(scenarioOutline);
				if (result == null) result = caseScenario(scenarioOutline);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.CONTENT: {
				Content content = (Content)theEObject;
				T result = caseContent(content);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.REFERENCE: {
				Reference reference = (Reference)theEObject;
				T result = caseReference(reference);
				if (result == null) result = caseContent(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.WORD: {
				Word word = (Word)theEObject;
				T result = caseWord(word);
				if (result == null) result = caseContent(word);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.EXAMPLE: {
				Example example = (Example)theEObject;
				T result = caseExample(example);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.BACKGROUND: {
				Background background = (Background)theEObject;
				T result = caseBackground(background);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.BEHAVIOR: {
				Behavior behavior = (Behavior)theEObject;
				T result = caseBehavior(behavior);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.SENTENCE: {
				Sentence sentence = (Sentence)theEObject;
				T result = caseSentence(sentence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDModelPackage.VALUE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Scenario Specific</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Scenario Specific</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseScenarioSpecific(ScenarioSpecific object) {
		return null;
	}
