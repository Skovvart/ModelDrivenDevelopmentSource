 ...
 * <ul>
 *   <li>{@link BDDModel.impl.ExampleImpl#getValues <em>Values</em>}</li>
 *   <li>{@link BDDModel.impl.ExampleImpl#getKeys <em>Keys</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExampleImpl extends EObjectImpl implements Example {
	...
	protected EClass eStaticClass() {
		return BDDModelPackage.Literals.EXAMPLE;
	}
	...
	public EList<String> getKeys() {
		if (keys == null) {
			keys = new EDataTypeUniqueEList<String>(String.class, this, BDDModelPackage.EXAMPLE__KEYS);
		}
		return keys;
	}
	...
	public EList<Value> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Value>(Value.class, this, BDDModelPackage.EXAMPLE__VALUES);
		}
		return values;
	}
