...
/**
 * This is the item provider adapter for a {@link BDDModel.Content} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BDDModelPackage.Literals.CONTENT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Content)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Content.class)) {
			case BDDModelPackage.CONTENT__VALUE:
